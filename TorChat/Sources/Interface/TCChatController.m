...
@interface TCChatController () <TCChatViewDelegate>
{	
...
- (void)receiveMessage:(NSString *)message forIdentifier:(NSString *)identifier
{
	...
	dispatch_async(dispatch_get_main_queue(), ^{
		...
		TCChatView	*view = [[_identifiersContent objectForKey:identifier] objectForKey:TCChatViewKey];
...
/*
** TCChatController - NSTableView
*/
#pragma mark - TCChatController - NSTableView
...
/*
** TCChatController - TCChatView
*/
#pragma mark - TCChatController - TCChatView
...
/*
** TCChatController - Helpers
*/
#pragma mark - TCChatController - Helpers
