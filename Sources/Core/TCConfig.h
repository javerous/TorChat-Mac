...
# define TCConfigBuddyName		"name"
# define TCConfigBuddyComment	"comment"
...
public:
	...
	virtual void			add_buddy(const std::string &address, const std::string &name, const std::string &comment) = 0;
	virtual bool			remove_buddy(const std::string &address) = 0;
	virtual void			set_buddy_name(const std::string &address, const std::string &name) = 0;
	virtual void			set_buddy_comment(const std::string &address, const std::string &comment) = 0;
	virtual  std::string	get_buddy_name(const std::string &address) const = 0;
	virtual  std::string	get_buddy_comment(const std::string &address) const = 0;
